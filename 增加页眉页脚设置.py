...
input_file_path = '护理项目居家上门明细-刘康京6月.xls'
output_file_path = '护理项目居家上门明细-刘康京6月数据透视表（包含页面设置）.xlsx'
...
# Set page margins
ws.page_margins = PageMargins(left=0.5, right=0.5, top=1, bottom=1, header=0.5, footer=0.5)
